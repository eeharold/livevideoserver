...
::seekStreamSource(FramedSource* inputSource, double seekNPT) {
  DEBUG_LOG(INF, "MP3AudioFileServerMediaSubsession::seekStreamSource");
...
::setStreamSourceScale(FramedSource* inputSource, float scale) {
  DEBUG_LOG(INF, "MP3AudioFileServerMediaSubsession::setStreamSourceScale");
...
::createNewStreamSource(unsigned /*clientSessionId*/, unsigned& estBitrate) {
  ...
  DEBUG_LOG(INF, "MP3AudioFileServerMediaSubsession::createNewStreamSource");
...
::createNewRTPSink(Groupsock* rtpGroupsock,
  ...
  DEBUG_LOG(INF, "MP3AudioFileServerMediaSubsession::createNewRTPSink");
  if (fGenerateADUs) {
